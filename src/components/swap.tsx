...
const Swap: React.FC = () => {
  ...
  const handleSwap = async () => {
    ...
    try {
      ...
      // Create a dummy DEEP coin (0 value) using the coin zero constructor
      const [dummyDeep] = tx.moveCall({
      ...
      const [, deepObtained] = tx.moveCall({
        ...
        arguments: [
          ...
          tx.pure(0, "u64"), // Dummy fee input (0) since pool is 0% fee
          tx.pure(0, "u64"), // min_base_out: 0 (accept any DEEP)
